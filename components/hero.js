...
export default function Hero({
  ...
  return (
    <div className={classNames("relative flex bg-center bg-no-repeat bg-cover md:h-[276px] text-white mb-4")}>
      {imageOverlay && (
      ...
      <Link href={`${heroLink}`} target={ openInNewWindow ? '_blank' : '_parent'} className={classNames("absolute inset-0 p-2 md:p-4 flex flex-col justify-end", textPosition[contentPosition])}>
          {brandName && (
